...
public class SuperErou {
	...
	public static class SuperErouBuilder{
		SuperErou superErou = null; //nu e gresita diagrama, s-ar putea si fara, prin replicarea atributelor 
		
		public SuperErouBuilder(String nume, int puncteViata) { //cerem atributele esentiale
